	...
	public static function Load(GenericEvent $event) {
		...
		$service->set_module('licenses')
			->set_enable(function() {
				...
				$subject = 'New ' . $service_name . ' License Created ' . $serviceInfo[$settings['PREFIX'].'_ip'];
				$headers = '';
				...
				$smarty = new TFSmarty;
				$smarty->assign('license_ip', $serviceInfo[$settings['PREFIX'] . '_ip']);
				$smarty->assign('service_name', (isset($service_name) ? $service_name : $serviceTypes[$serviceInfo[$settings['PREFIX'] . '_type']]['services_name']));
